"""
Django settings for solarbanyu_app project.
...
SECRET_KEY = 'django-insecure-p0y_hver8@q21#oqg^cc&^r(s7njswmj16um%z0&t6q&ljj=5('
...
ROOT_URLCONF = 'solarbanyu_app.urls'
...
WSGI_APPLICATION = 'solarbanyu_app.wsgi.application'
