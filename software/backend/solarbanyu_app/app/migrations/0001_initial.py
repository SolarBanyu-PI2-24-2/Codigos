    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('criado_em', models.DateTimeField(auto_now_add=True)),
                ('dispositivo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='consumos', to='app.dispositivo')),
            ],
        ),
        migrations.CreateModel(
            name='Alerta',
            fields=[
                ...
                ('criado_em', models.DateTimeField(auto_now_add=True)),
                ('dispositivo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='alertas', to='app.dispositivo')),
            ],
        ),
        migrations.CreateModel(
            name='Endereco',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('criado_em', models.DateTimeField(auto_now_add=True)),
                ('sensor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='dados', to='app.sensor')),
            ],
        ),
    ]
